# Migrating from `@bcts/provenance-mark` to `@blockchaincommons/provenance-mark`
...
migration is a rename. `@bcts/provenance-mark` remains published for one beta cycle as a
...
- The wire format. Encodings produced by `@bcts/provenance-mark` decode here, and the reverse.
