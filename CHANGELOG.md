...
Extracted from the [`paritytech/bcts`](https://github.com/paritytech/bcts) monorepo, where this library was published as `@bcts/provenance-mark`. The public API is unchanged; see [MIGRATION.md](./MIGRATION.md).

---

## History as `@bcts/provenance-mark`
